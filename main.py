...
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","@GOD_HYPER_O_P")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","@Ayodhya_nagri_chatting_group")
...
SOURCE = 'https://github.com/Shivam92051/BRANDEDCHATBOT/edit/Dev/main.py'
x=["❤️","🎉","✨","🪸","🎉","🎈","🎯"]
g=choice(x)
...
async def restart(client, m: Message):
        ...
        await accha.edit("🦋𝗡𝗢𝗪 𝗖𝗢𝗠𝗘 𝗛𝗘𝗥𝗘 👉 @HYPER_WORLD_XD , @HYPER_WORLD_XD , @Ayodhya_nagri_chatting_group 𝗔𝗡𝗗 𝗠𝗔𝗞𝗘 𝗬𝗢𝗨𝗥 𝗚𝗜𝗥𝗟𝗙𝗥𝗜𝗡𝗗 🥀💋 𝗜𝗙 𝗬𝗢 𝗛𝗔𝗩𝗘 𝗔 𝗚𝗜𝗥𝗟𝗙𝗜𝗘𝗡𝗗  😘 𝗧𝗛𝗘𝗡 𝗬𝗢𝗨 𝗪𝗜𝗟𝗟 𝗚𝗜𝗙𝗧 🙊 𝗧𝗢 𝗠𝗬 𝗢𝗪𝗡𝗘𝗥 @GOD_HYPER_O_P ❤️")
